		...
		Private Sub processError(rsp as ProfileResponse)
		  ...
		  case app.kDuplicateRecordCode
		    ...
		    case ValidState.CreatePaymentProfile
		      ...
		      MsgBox "An error occured while trying to store your credit card information. Please try again."
...
#tag Events ANetProfileManager1
	#tag Event
		Sub Error(err as xojo.Net.NetException)
		  ...
		  MsgBox "An error occured while trying to store your credit card informaiton, please try again."
		  MovementControl1.ActivatePrimary()
		End Sub
	#tag EndEvent
	#tag Event
		Sub ResponseRecieved(response as ProfileResponse)
		  ...
		  if response.isSuccess then
		    ...
		    case ValidState.CreatePaymentProfile
		      ...
		      AdvancePageTimer.Mode = timer.ModeSingle
		...
		Sub Action()
		  if nextRequest <> Nil then 
		    try
		      ...
		      MsgBox "An error has occured while trying to store your credit card information. Please try again."
